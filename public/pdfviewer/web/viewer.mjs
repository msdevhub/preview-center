...
{
  const HOSTED_VIEWER_ORIGINS = ["null", "http://mozilla.github.io", "https://mozilla.github.io","https://s28.q4cdn.com","http://localhost:3002"];
  var validateFileURL = function (file) {
    ...
    try { 
      ...
      if (fileOrigin !== viewerOrigin) {
        console.info("file origin does not match viewer's");
      }
    } catch (ex) {
